...
use crate::theme::{
    Accent, Background, BorderColors, BorderWidth, ComponentSize, FontSize, IconSize, Layout,
    MediaPanel, Opacity, Radius, Spacing, Status, Text,
};
...
use gpui::{
    div, prelude::*, px, AnyElement, App, ClickEvent, Context, DragMoveEvent, Entity, FocusHandle,
    Focusable, Hsla, InteractiveElement, IntoElement, MouseButton, MouseDownEvent, ParentElement,
