...
impl Render for InspectorView {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let fade_in_row = self.scrub_row(
            "fade_in",
            "Fade In",
            0.0,
            10.0,
        ...
        let fade_out_row = self.scrub_row(
            "fade_out",
            "Fade Out",
            0.0,
            10.0,
        ...
        let text_size_row = self.scrub_row(
            "text_size",
            "Size",
            1.0,
            1000.0,
        ...
        let align_row = div()
            ...
            .child(
                div().flex().flex_row().gap(px(Spacing::XXS)).children(
                    ["⬛", "⬜", "⬛", "⬛"]
                        .iter()
                        .enumerate()
                        .map(|(i, glyph)| {
