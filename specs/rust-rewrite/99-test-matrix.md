...
| `TIM`, `TRK`, `CLP`, `LNK`, `RPL`, `SNP`, `RNG`, `INS`            | Pure-core unit/property tests                        | `Tests/PalmierProTests/Timeline/**`                                                             | ripple, snapping, range-selection, track ops, and broader link propagation |
