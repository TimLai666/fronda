...
| `TIM`, `TRK`, `CLP`, `LNK`, `RPL`, `SNP`, `RNG`, `INS`            | Pure-core unit/property tests                        | `Tests/PalmierProTests/Timeline/**`                                                             | snapping, range-selection, track ops, full ripple insert (straddle split, sequential), and timeline-setting changes |
