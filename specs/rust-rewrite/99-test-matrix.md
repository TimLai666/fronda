...
| `TIM`, `TRK`, `CLP`, `LNK`, `RPL`, `SNP`, `RNG`, `INS`            | Pure-core unit/property tests                        | `Tests/PalmierProTests/Timeline/**`                                                             | snapping, range-selection, track ops, end-to-end ripple workflows, and timing-style link propagation |
